        ...
        if (sV4WrappedDrawableClass != null) {
            if (sV4WrappedDrawableGetM == null) {
                try {
                    ...
                    Log.i(TAG, "getV4WrappedDrawableWrappedDrawable No Such Method");
                }
            }
            if (sV4WrappedDrawableGetM != null) {
                try {
                    ...
                    Log.i(TAG, "getV4WrappedDrawableWrappedDrawable invoke error: " + e);
                }
            }
        }
        return drawable;
        ...
        if (sV4WrappedDrawableClass != null) {
            if (sV4WrappedDrawableSetM == null) {
                try {
                    ...
                    Log.i(TAG, "setV4WrappedDrawableWrappedDrawable No Such Method");
                }
            }
            if (sV4WrappedDrawableSetM != null) {
                try {
                    ...
                    Log.i(TAG, "setV4WrappedDrawableWrappedDrawable invoke error: " + e);
                }
            }
        }
    }
        ...
        if (sV4DrawableWrapperClass != null) {
            if (sV4DrawableWrapperGetM == null) {
                try {
                    ...
                    Log.i(TAG, "getV4DrawableWrapperWrappedDrawable No Such Method");
                }
            }
            if (sV4DrawableWrapperGetM != null) {
                try {
                    ...
                    Log.i(TAG, "getV4DrawableWrapperWrappedDrawable invoke error: " + e);
                }
            }
        }
        return drawable;
        ...
        if (sV4DrawableWrapperClass != null) {
            if (sV4DrawableWrapperSetM == null) {
                try {
                    ...
                    Log.i(TAG, "setV4DrawableWrapperWrappedDrawable No Such Method");
                }
            }
            if (sV4DrawableWrapperSetM != null) {
                try {
                    ...
                    Log.i(TAG, "setV4DrawableWrapperWrappedDrawable invoke error: " + e);
                }
            }
        }
    }
        ...
        if (sV7DrawableWrapperClass != null) {
            if (sV7DrawableWrapperGetM == null) {
                try {
                    ...
                    Log.i(TAG, "getV7DrawableWrapperWrappedDrawable No Such Method");
                }
            }
            if (sV7DrawableWrapperGetM != null) {
                try {
                    ...
                    Log.i(TAG, "getV7DrawableWrapperWrappedDrawable invoke error: " + e);
                }
            }
        }
        return drawable;
        ...
        if (sV7DrawableWrapperClass != null) {
            if (sV7DrawableWrapperSetM == null) {
                try {
                    ...
                    Log.i(TAG, "setV7DrawableWrapperWrappedDrawable No Such Method");
                }
            }
            if (sV7DrawableWrapperSetM != null) {
                try {
                    ...
                    Log.i(TAG, "setV7DrawableWrapperWrappedDrawable invoke error: " + e);
                }
            }
        }
    }
